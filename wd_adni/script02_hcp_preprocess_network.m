...
work_dir = "/home/niki/Downloads//FullData_Oct26/";
input_dir = strcat(work_dir, "out01_hcp_corr_matrix");
output_dir = strcat(work_dir, "out02_hcp_harmonics");
...
for i = 1:length(files)
    ...
    CorrMatrix = fscanf(fileID, '%f');
    
    % out_file_name = strcat('PreprocessCorrMat', files(i).name(18:end))
    subject_id = files(i).name(12:end-4)
...
writematrix(CommonHarWavelets, 'output_file.csv', 'Delimiter', ',')
